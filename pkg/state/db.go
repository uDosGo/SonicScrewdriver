...
// InstallState represents the installation state of a game
...
func (db *DB) GetInstallation(name string) (*InstallState, error) {
...
func (db *DB) ListInstallations() ([]InstallState, error) {
	...
	var installations []InstallState
	for rows.Next() {
		var state InstallState
